...
import { useFullActorsData } from "../../shared/hooks/getActorCredentials";
...
const ActorDetail = () => {
  ...
  const { data: actorsCredentials, isLoading } = useFullActorsData(
    Number(id),
    "movie_credits",
    "cast"
  );
  ...
  return (
    <section className="dark:bg-[#000000] dark:transition-all transition-all pt-7">
      <div className="container flex flex-col">
        <div className="flex flex-col min-[1100px]:flex-row bg-white shadow-lg rounded-lg overflow-hidden gap-8 dark:bg-[#000000] dark:transition-all transition-all">
        ...
        <Title
          text="Related Movie"
          className="dark:text-[var(--color-py)] pt-10 pb-3"
        />
        <MovieView data={actorsCredentials} isLoading={isLoading} />
      </div>
    </section>
  );
};
