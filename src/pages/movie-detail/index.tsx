...
const MovieDetail = () => {
  ...
  return (
    <div className="container mt-[10px] flex flex-col">
      <div className="flex gap-[30px] max-[1200px]:flex-col">
        ...
        <div className="w-[50%] bg-white rounded-lg shadow-lg px-6 pt-2 max-[1200px]:w-full max-[1200px]:pb-3">
      ...
      <div className="flex gap-[20px] overflow-x-auto mt-10 h-[220px]">
      ...
      <div className="mt-[30px]">
        ...
        <div className="flex gap-[20px] overflow-auto mt-[20px]">
